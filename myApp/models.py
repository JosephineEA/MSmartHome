...
# Feel fre599美元e to rename the models, but don't rename db_table values or field names.
...
class Furniture(models.Model):
    ...
    def scheme_one(self):
        return {"furnitureid":self.furnitureid,"furniturename":self.furniturename}
...
class Multicommand(models.Model):
    multicommandid = models.CharField(db_column='MultiCommandID',  max_length=20)  # Field name made lowercase.
    ...
    def scheme_one(self):
        return {"multicommandid":self.multicommandid,"multicommandname":self.multicommandname}
    class Meta:
        managed = False
...
class UserFlatRole(models.Model):
    ...
    flatid = models.ForeignKey(Flat, models.DO_NOTHING, db_column='FlatID', blank=True, null=True)  # Field name made lowercase.
    roleid = models.ForeignKey(Role, models.DO_NOTHING, db_column='RoleID')  # Field name made lowercase.
    ifentered = models.CharField(db_column='IfEntered', max_length=1, blank=True, default=0)  # Field name made lowercase.
